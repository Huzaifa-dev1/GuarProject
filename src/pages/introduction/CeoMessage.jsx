        ...
        >
          <motion.div className="leader-col leader-col--text" variants={slideIn("left", 120)}>
            ...
            <div className="leader-copy">
              <p>
                KAMAR GROUP is an establishment based on originality—whether it’s the originality of the
              ...
              <p>
                KAMAR GROUP is currently operating in the export of Alfalfa and Rhodes grass**,
              ...
              <p>
                KAMAR GROUP is solely established and designed with the intention of practically benefiting
                the economy, business, and humanity by allowing better living standards for all.
              </p>
              <p>
                “What one does is what counts.” KAMAR GROUP truly and sincerely intends to do responsible
